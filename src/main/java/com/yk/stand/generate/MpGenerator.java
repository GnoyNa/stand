...
//	        gc.setSwagger2(true);					//开启 swagger2 模式 默认false
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/stand?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//	        strategy.setSuperControllerClass("com.baomidou.ant.common.BaseController");	//自定义继承的Controller类全称，带包名
        strategy.setInclude(new String[] { "user" });		//需要包含的表名，允许正则表达式（与exclude二选一配置）
